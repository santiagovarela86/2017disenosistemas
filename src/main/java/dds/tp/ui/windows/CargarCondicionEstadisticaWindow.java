...
public class CargarCondicionEstadisticaWindow extends Window<CargarCondicionEstadisticaViewModel>{
	...
	public void createContents(Panel mainPanel) {
		...
		new Label(panel4).setText("Calculo");
		Selector<CargarCondicionEstadisticaViewModel> selectorTipoCalculo = new Selector<CargarCondicionEstadisticaViewModel>(panel4);
		selectorTipoCalculo.bindItemsToProperty("calculos");
		selectorTipoCalculo.bindValueToProperty("calculo");
