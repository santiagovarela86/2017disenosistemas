...
//Esto es para calcular el indicador
  final public float evaluar(Evaluador ev) throws ParseException {
        float valor;
        float i;
    valor = termino(ev);
    label_2:
  ...
  final public float termino(Evaluador ev) throws ParseException {
  float valor;
  float i;
    valor = getValor(ev);
    label_3:
  ...
  final public float getValor(Evaluador ev) throws ParseException {
        Token t;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case NUMERO:
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x10c,0xf0,0xf0,0x10c,0x30,0x30,0xc0,0xc0,0x10c,};
   }
