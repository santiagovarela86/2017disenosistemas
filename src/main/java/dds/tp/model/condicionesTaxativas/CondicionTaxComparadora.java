...
@Entity
@DiscriminatorValue("condTaxativaComparadora")
public class CondicionTaxComparadora extends CondicionTaxativa {
	
	public CondicionTaxComparadora() {
		// TODO Auto-generated constructor stub
	}
	
	public CondicionTaxComparadora(String nombre, String descripcion, Comparable indicador, Comparador comparador,
