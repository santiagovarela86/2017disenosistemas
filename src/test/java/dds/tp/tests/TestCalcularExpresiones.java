...
public class TestCalcularExpresiones {
	...
	public void testCalculoIndicadoresNoErrorsConSoloNumeros()  {
		Indicador uno = new Indicador("test", new Expresion(new Parser().parsear("7+5*2")));
		Indicador dos = new Indicador("testuno", new Expresion(new Parser().parsear("7+9/3")));
	...
	public void testCalculoIndicadoresNoErrorsConCuentaYNumeros()  {
		Indicador uno = new Indicador("test", new Expresion(new Parser().parsear("7+Roe*2")));
		Indicador dos = new Indicador("test", new Expresion(new Parser().parsear("7+FDS*2+5+9/3")));
	...
	public void testCalculoIndicadoresNoErrorsConCuentaYNumerosEIndicadores()  {
		Indicador uno = new Indicador("test", new Expresion(new Parser().parsear("10+Roe*2")));
		Indicador dos = new Indicador("testuno", new Expresion(new Parser().parsear("test/5*2+5")));
	...
	public void TestNoSePermitenIndicadoresConElMismoNombre(){
		Indicador uno = new Indicador("test", new Expresion(new Parser().parsear("10+Roe*2")));
		Indicador dos = new Indicador("test", new Expresion(new Parser().parsear("test/5*2+5")));
		baulIndicadores.addIndicador(uno);
	...
	public void TestErrorAlCalcularYNoTenerLaCuentaOElIdentificador()  {
		Indicador uno = new Indicador("test", new Expresion(new Parser().parsear("10+pepe*2")));
